<template>
    <div class="container-fluid">
            ...
            <div class="d-flex align-items-center">
                  <h2 class="card-title">Product Brands</h2>
                    <div class="mx-auto input-group px-4">
                        <input type="search" @keyup="searchit" v-model="searchB" class="form-control br-tl-7 br-bl-7" placeholder="Search categories....">
        ...
        <div class="col-lg-12">
                <div class="row">
                    <div class="col-sm-4 col-lg-4" v-for="category in categories.data" :key="category.id">
                        <div class="card item-card">
                            <div class="product-grid  card-body">
                                <div class="product-image">
                                    <a href="#">
                                        <img class="product-img" v-bind:src="'/img/categoryLogo/' + category.photo">
                                    </a>
                                </div>
                                ...
                                <ul class="icons">
                                    ...
                                    <li id="p-view"><a href="#" v-b-modal.product-details @click="showCategory(category)" v-b-tooltip.hover title="View Category"><i class="fa fa-eye"></i></a></li>
                                    <li v-if="$gate.isAdminORDeveloper()" id="p-edit"><a href="#" v-b-tooltip.hover title="Edit Category" @click="editModal(category)" data-tip="Edit category"><i class="fa fa-edit"></i></a></li>
                                    <li v-if="$gate.isAdminORDeveloper()" id="p-delete"><a href="#" @click="deleteCategory(category.id)" v-b-tooltip.hover title="Delete Category"><i class="fa fa-trash-alt"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<!-- ANCHOR : Modal -->
        ...
        <div class="modal-dialog modal-dialog-centered mod-dg" role="document">
            ...
            <form enctype="multipart/form-data" method="POST" @submit.prevent="editmode ? updateBrand() :createCategory() ">
            <div class="modal-body mod-bdy">
                ...
                <div class="form-group">
                    Photo:
                            <input type="file" @change="addPhoto" name="logo" id="form-input">
                </div>
