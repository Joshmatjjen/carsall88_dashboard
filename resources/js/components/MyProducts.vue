<template>
    <div class="container-fluid">
        ...
        <div class="col-lg-9">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-4 col-md-12" v-for="product in products.data" :key="product.user_id">
                        <div class="card item-card">
                            <div class="product-grid  card-body">
                                ...
                                <ul class="icons">
                                    ...
                                    <li id="p-delete"><a href="#" @click="deleteProduct(product.id)" v-b-tooltip.hover title="Delete Product"><i class="fa fa-trash-alt"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        // },
            ...
            loadMyProducts(){
                // if(this.$gate.isAdminORAuthor()){
                    axios.get("api/myProducts").then(({ data }) => ((this.products = data)));
