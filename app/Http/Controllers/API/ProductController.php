...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->photo1 != ''){
            ...
            \Image::make($request->photo1)->resize(2100, 900)->save(public_path('img/productImage/').$photo1);
        }else{
        ...
        if($request->photo2 != ''){
            ...
            \Image::make($request->photo2)->resize(2100, 900)->save(public_path('img/productImage/').$photo2);
        ...
        if($request->photo3 != ''){
            ...
            \Image::make($request->photo3)->resize(2100, 900)->save(public_path('img/productImage/').$photo3);
        ...
        \Image::make($request->photo4)->resize(2100, 900)->save(public_path('img/productImage/').$photo4);
